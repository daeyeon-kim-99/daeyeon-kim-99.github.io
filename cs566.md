...
<div class="figure-grid">
  <div class="figure-card">
    ...
    <div class="figure-caption">
      ResNet18 · mini COCO (20K) – training/validation loss up to 30 epochs.
    </div>
  </div>
  <div class="figure-card">
    ...
    <div class="figure-caption">
      ResNet18 · mini COCO (20K) – loss curve when training longer (50 epochs).
    </div>
  </div>
  <div class="figure-card">
    ...
    <div class="figure-caption">
      ResNet18 · mini COCO (20K) – PCK@0.05 evolution up to 30 epochs.
    </div>
  </div>
  <div class="figure-card">
    ...
    <div class="figure-caption">
      ResNet18 · mini COCO (20K) – PCK@0.05 when training is extended to 50 epochs.
    </div>
  </div>
</div>
...
<div class="figure-grid">
  <div class="figure-card">
    ...
    <div class="figure-caption">
      ResNet18-FPN · full COCO (250K) – loss curve for 30-epoch training.
    </div>
  </div>
  <div class="figure-card">
  ...
  <div class="figure-card">
    ...
    <div class="figure-caption">
      ResNet18-FPN · lower-body fully visible 60K – loss curve for 30 epochs.
    </div>
  </div>
  <div class="figure-card">
    ...
    <div class="figure-caption">
      ResNet18-FPN · lower-body fully visible 60K – PCK@0.05 over 30 epochs.
    </div>
  </div>
</div>
...
<div class="figure-grid">
  <div class="figure-card">
    ...
    <div class="figure-caption">
      Dilated CNN · 60K – loss curve for 80-epoch training.
    </div>
  </div>
  <div class="figure-card">
    ...
    <div class="figure-caption">
      Dilated CNN · 60K – loss curve for 160-epoch training.
    </div>
  </div>
  <div class="figure-card">
