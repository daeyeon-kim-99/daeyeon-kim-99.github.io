...
> ⚠️ We still divide by **6**, even if some joints are invisible.  
...
<div class="figure-grid">
  ...
  <p class="exp-note">
    With 30 epochs, the baseline already reaches a reasonable loss and PCK, showing that the model can learn from a small subset.
  </p>
  ...
  <p class="exp-note">
    Extending training to 50 epochs gives only limited gain and slightly noisier curves, suggesting early convergence on this small dataset.
  </p>
  <div class="figure-row">
    <div class="figure-card">
...
<div class="figure-grid">
  ...
  <p class="exp-note">
    Training on full COCO exposes the model to diverse poses, but many legs are partially occluded, which limits lower-body supervision.
  </p>
  <div class="figure-row">
    <div class="figure-card">
      ...
      <div class="figure-caption">
        ResNet18-FPN · full COCO (250K) – loss over 30 epochs.
      </div>
    </div>
    <div class="figure-card">
      ...
      <div class="figure-caption">
        ResNet18-FPN · full COCO (250K) – PCK@0.05 over 30 epochs.
      </div>
    </div>
  </div>
  ...
  <p class="exp-note">
    The curated 60K subset gives cleaner leg supervision; loss decreases smoothly and PCK is more stable for lower-body joints.
  </p>
  <div class="figure-row">
    <div class="figure-card">
...
<div class="figure-grid">
  ...
  <p class="exp-note">
    After 80 epochs, the lightweight CNN reaches a reasonable loss and PCK, but still lags behind the FPN-based ResNet.
  </p>
  <div class="figure-row">
    <div class="figure-card">
  ...
  <p class="exp-note">
    Doubling the schedule to 160 epochs slightly improves stability but does not close the gap with ResNet18-FPN, showing the limit of this simple architecture.
  </p>
  <div class="figure-row">
    <div class="figure-card">
