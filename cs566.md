...
- Even though training is extended from 30 to 50 epochs, both the qualitative maps and the metrics in the table show **no dramatic improvement**.
...
- However, heatmaps are **not as sharp** as those from FPN models, showing **lower confidence and precision**.  
- This suggests the model can handle **compact poses**, but struggles with **fine-grained localization**.

**Sample 2**  
- This harder pose reveals the model’s **core limitations**.  
- When joints are **far apart**, the simple CNN fails to capture **long-range relationships**, producing **blurry, low-confidence heatmaps**.
---
