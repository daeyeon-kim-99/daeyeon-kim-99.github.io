...
- **Sample 2.**  
  ...
  With the **60K fully visible + FPN model**, the loss decreases to **0.003640** and PCK jumps to **0.3333**, meaning the model finally predicts the far joints correctly.
